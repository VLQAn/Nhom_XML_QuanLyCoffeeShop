...
namespace XML_QuanLyCoffeeShop.UI
{
    ...
    private void ShowFormInPanel(Form formToShow, string tenMuc)
        ...
        private void to_NhanVien_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new FormQuanLyNhanVien(), "NHÂN VIÊN");
        }

        private void to_KhachHang_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new FormQuanLyKhachHang(), "KHÁCH HÀNG");
        }
    }
}
